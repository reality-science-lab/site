...
### 6.4　雨ニモマケズ高等学校連携 ― 自己スケールの現実編集

来年4月開校予定の「雨ニモマケズ高等学校」のレジリエンス教育と、デジタルハリウッド大学を高大連携で接続します。15〜18 歳という、最も自己定義が硬化しやすい時期に、可動域を保ったまま大人になる訓練を提供する ― これがこのプロジェクトの目的です。
...
**プロジェクトリーダー**：各旗艦プロジェクト（PPP、シンギュラボ連携、攻撃学、雨ニモマケズ高等学校連携）に専任または兼任のリーダーを置きます。
